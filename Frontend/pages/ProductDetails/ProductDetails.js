...
const tabs = [
  
  {
    ...
    label: "Description",
    content:
      " Perfect Gift for Every Occasion – Thoughtfully Curated, High-Quality, and Guaranteed to Delight!",
  },
...
const ProductDetails = () => {
  ...
  return (
    <div className="w-full mx-auto border-b-[1px] border-b-gray-300" style={{ backgroundColor: '#D5F0C1' }} >
